...
class GR_API GrEGLImage : public GrRefCnt {
public:
    virtual ~GrEGLImage() { }
    virtual void* data() = 0;
    virtual int stride() = 0;
    virtual void* eglImage() = 0;
};
 ...
 */
GR_API const GrGLInterface* GrGLCreateNativeInterface();
...
extern "C" {
    ...
    // EGLImages as textures
    typedef GrGLvoid (GR_GL_FUNCTION_TYPE *GrGLEGLImageTargeTexture2DOESProc)(GrGLenum target, void* image);

    // Create EGLImage
    typedef GrEGLImage* (GR_GL_FUNCTION_TYPE *GrcreateEGLImageProc)(GrGLint width, GrGLint height);
    
    // Make current the context for this interface
    typedef void (GR_GL_FUNCTION_TYPE *GrmakeCurrentProc)(void*);
}  // extern "C"
...
struct GR_API GrGLInterface : public GrRefCnt {
    ...
    // EGLImages as textures
    GrGLEGLImageTargeTexture2DOESProc fEGLImageTargetTexture2DOES;

    // Create EGLImage
    GrcreateEGLImageProc fcreateEGLImage;
    
    // Make current the context for this interface
    GrmakeCurrentProc fmakeCurrent;
