...
public:
    ...
    */
    ...
    struct FontMetrics {
        ...
        SkScalar    fWinAscent;   //!< The windows-compatible distance above the baseline (will be >= 0)
        SkScalar    fWinDescent;   //!< The windows-compatible distance below the baseline (will be >= 0)
