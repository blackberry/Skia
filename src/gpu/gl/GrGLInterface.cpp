...
GrGLInterface::GrGLInterface()
    ...
    , fDetachShader(&fFunctions.fDetachShader)
    ...
    , fBlendFuncSeparate(&fFunctions.fBlendFuncSeparate)
    ...
    , fIsEnabled(&fFunctions.fIsEnabled)
    ...
    , fGetAttribLocation(&fFunctions.fGetAttribLocation)
    ...
    , fGetShaderSource(&fFunctions.fGetShaderSource)
    ...
    , fProgramBinary(&fFunctions.fProgramBinary)
    , fGetProgramBinary(&fFunctions.fGetProgramBinary) {
