...
const GrGLInterface* GrGLCreateNativeInterface() {
    ...
    if (!glInterface.get()) {
        ...
        // IMG_multisample
        interface->fRenderbufferStorageMultisample = (PFNGLRENDERBUFFERSTORAGEMULTISAMPLEIMGPROC)eglGetProcAddress("glRenderbufferStorageMultisampleIMG");
        interface->fFramebufferTexture2DMultisample = (PFNGLFRAMEBUFFERTEXTURE2DMULTISAMPLEIMGPROC)eglGetProcAddress("glFramebufferTexture2DMultisampleIMG");

        // EGLImage
        interface->fEGLImageTargetTexture2DOES = (PFNGLEGLIMAGETARGETTEXTURE2DOESPROC)eglGetProcAddress("glEGLImageTargetTexture2DOES");
    }
    glInterface.get()->ref();
